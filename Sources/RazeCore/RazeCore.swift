...
public class RazeCore {
    ...
    /// - Parameters:
    ///   - hexString: A 6-digit hex string. Use 6 digits rather than 8, and add the accompanying alpha value in the second parameter
    ...
    internal class func colorFromHexString(
        _ hexString: String,
        alpha: CGFloat = 1.0
    ) -> UIColor {
        let r, g, b: CGFloat
